...
const Kedarnath = () => {
  const kedarnathData = {
    ...
    itinerary: [
      { time: "Day 0: Journey Begins – Pune to Haridwar", desc: "Our adventure begins from Pune as we make our way to Mumbai by train or private vehicle. From Mumbai, we board our train to the spiritual gateway of the north — Haridwar." },
      { time: "Day 1: Arrival in Haridwar | Explore the Sacred Town", desc: "Upon arrival in Haridwar, we check into our hotel and take some time to rest. Later, we head out to explore this holy town — visiting the serene Har Ki Pauri Ghat and the hilltop Mansa Devi Temple. As the sun sets, we witness the mesmerizing Ganga Aarti, a spiritual experience that stays with you forever. We return to our hotel for dinner and an overnight stay." },
      { time: "Day 2: Haridwar to Sonprayag | Scenic Drive through the Hills", desc: "We begin our scenic drive to Sonprayag, passing through picturesque towns like Rishikesh, Devprayag, Srinagar, and Rudraprayag, following the flow of the Ganga and Alaknanda rivers. By evening, we reach Sonprayag and check into our guesthouse, soaking in the crisp mountain air." },
      { time: "Day 3: Trek to Kedarnath | A Journey of Devotion and Beauty", desc: "We start early with a short drive to Gaurikund — the base of our trek. From here, we begin the uphill journey towards Kedarnath, traversing lush forests, scenic valleys, and river crossings. By late afternoon, we reach Kedarnath and check into our accommodation. As dusk falls, we attend the peaceful evening Aarti at the Kedarnath Temple. Overnight stay in Kedarnath." },
      { time: "Day 4: Morning Darshan | Trek Back to Sonprayag", desc: "We rise early for darshan at the Kedarnath Temple, embracing the divine atmosphere in the quiet morning hours. After some serene moments, we begin our descent back to Gaurikund and proceed to Sonprayag. We check in, rest, and rejuvenate after the long yet fulfilling day." },
      { time: "Day 5: Sonprayag to Rishikesh | Back to the Banks of the Ganga", desc: "After breakfast, we set off for Rishikesh. The route is lined with Himalayan landscapes and flowing rivers, making the drive picturesque and peaceful. By evening, we arrive in Rishikesh and settle into our hotel. The evening is free to explore riverside cafés or take a quiet stroll by the Ganga. Overnight stay in Rishikesh." },
      { time: "Day 6: Explore Rishikesh | Adventure & Spiritual Bliss", desc: "We spend the day soaking in the spiritual and vibrant vibes of Rishikesh — visiting Laxman Jhula, Ram Jhula, the Beatles Ashram, and colorful local markets. For thrill-seekers, we indulge in the exhilarating river rafting experience. In the evening, we gather at Triveni Ghat for the soulful Ganga Aarti. Overnight stay in Rishikesh." },
      { time: "Day 7: Rishikesh to Delhi | Train to Pune", desc: "After breakfast, we begin our return journey with a drive to Delhi. From there, we board our train back to Pune. The journey offers time to relax, reflect, and relive the beautiful memories we've made." },
      { time: "Day 8: Homecoming | Arrive in Pune", desc: "We arrive back in Pune, our hearts full of blessings, our minds refreshed by the mountains, and our spirits uplifted by the divine and adventurous experiences of the past few days." }
    ],
