...
const birbilling = () => {
  const birBillingData = {
    ...
    description: "Bir Billing is a serene town in Himachal Pradesh, renowned worldwide for paragliding and peaceful monasteries. This trek combines adventure, culture, and natural beauty for an unforgettable experience.",
    parallaxImage: BirPara,
    price: "₹16,999/-",
    slots: "👥 20 Explorers",
    schedule: "🕒 December 2025 - New Year Special",
    boardingPoints: ["Pune", "Chandigarh"],
    historyText: "Bir Billing is not just an adventure destination; it’s a blend of culture, tranquility, and adrenaline. Known as the paragliding capital of India, the region offers breathtaking Himalayan views, quaint cafés, and vibrant monasteries. This journey is perfect for explorers seeking both thrill and serenity.",
    includes: [
