          ...
          <div className="py-6 sm:py-8 lg:py-12 animate-on-scroll opacity-0 translate-y-10 transition-all duration-700 ease-out px-2 sm:px-0" 
            ...
            <div className="max-w-full">
              <p className="text-gray-700 text-xs xs:text-sm sm:text-base lg:text-lg xl:text-xl leading-relaxed text-left break-words hyphens-auto">
                Aadrai Jungle is a hidden gem nestled in the Malshej Ghat region, offering a serene trek through dense forest, cascading waterfalls, and ancient caves. Perfect during the monsoon, it’s a nature lover’s paradise surrounded by untouched wilderness.
              </p>
            </div>
          </div>
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <span className="ml-2 sm:ml-3 text-base sm:text-lg lg:text-xl text-gray-700 break-words">Reporting at Given pick up points & Depart towards Khireshwar.</span>
                      </div>
                    </div>
                  </div>
                </div>
