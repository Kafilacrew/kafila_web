...
const RajmachiFireflies = () => {
  const rajmacData = {
    ...
    itineraries: [
      ...
      {
        title: "Manaranjan Fort & Return",
        subtitle: "Day 2",
        items: [
          { time: "08:30 AM", desc: "Breakfast and start the hike to Manaranjan." },
          { time: "09:30 AM", desc: "Reach the fort, explore its historical side." },
          { time: "11:30 AM", desc: "After descending, freshen up & leave for Pune." },
